...
void TestESDIg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TestESDIg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TestESDIg::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_TestESDIg.data,
    qt_meta_data_TestESDIg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
